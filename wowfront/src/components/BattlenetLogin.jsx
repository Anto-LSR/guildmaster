      ...
      <div className="text-center w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
        ...
        <div className="lg:mt-0 lg:flex-shrink-0">
          <div className="mt-12 inline-flex rounded-md shadow">
            <a
              href={`https://eu.battle.net/oauth/authorize?client_id=52ca743814104e579461de2c112f232e&redirect_uri=${process.env.REACT_APP_BASEURL}/bnet/auth&response_type=code&scope=wow.profile`}
