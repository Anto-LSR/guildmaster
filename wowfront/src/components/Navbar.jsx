    ...
    <>
      ...
      >
        ...
        {userInfo && !characterData && userInfo?.bnetLinked == null && (
          <div className="mt-10 ">
            ...
            <p className="mt-3 pb-5 text-white divide border-dashed border-b border-0">
              To Apply to a guild and see your characters details, please link
              your <span className="text-primary">battle.net</span> account to
              your guildmaster.io account.
            </p>
          </div>
        )}
        {/* ----------------------END---------------------- */}
        <ul className="mt-20 ml-10 text-white">
          {userInfo && (
            <li className="nav flex items-center text-lg cursor-pointer hover:text-primary transition ease-in-out mt-3">
          ...
          <li className=" flex">
            {userInfo && characterData && (
              <div className="flex">
                <div className="flex items-center text-lg cursor-pointer  hover:text-primary  transition ease-in-out">
          ...
          <li className="nav-active-link flex items-center text-lg cursor-pointer hover:text-primary transition ease-in-out ">
