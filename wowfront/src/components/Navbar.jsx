...
function Navbar() {
  ...
  return (
    <div className="float-left w-64 bg-[#252525] h-screen">
      ...
      <button className="bg-[#41B0C9] hover:bg-[#2A7484] text-white font-bold py-2 px-4 border-b-4 border-[#2A7484] hover:border-[##2A7484] rounded transition ease-in-out">
        Change character
      </button>

      <ul className="mt-10 ml-10 text-white">
        <li className=" flex">
          <div className="flex items-center text-xl cursor-pointer  hover:text-[#41B0C9]  transition ease-in-out">
            <BiShieldQuarter className="mr-5" />
            My Guild &nbsp;
          </div>
          <div className="rounded-full bg-red-500 w-7  ">2</div>
        </li>
        <li className="nav-active-link flex items-center text-xl cursor-pointer hover:text-[#41B0C9] transition ease-in-out mt-3">
          <VscWorkspaceUnknown className="mr-5" />
          Find a guild
        </li>
      </ul>
      <a className="absolute bottom-5 left-10 text-white flex items-center hover:text-[#41B0C9] cursor-pointer">
        <FiLogOut /> &nbsp; Log out
      </a>
    </div>
  );
